...
export default Component.extend({
  ...
  didInsertElement() {
    if(this.get('dragCoordinator').hasSameDragObject(this) && !this.get('dragCoordinator').hasSameDragItem(this)) {
      this.get('dragCoordinator').dragItemChanged(this);
      next(()=> {
        this.dragStartHook({target: this.element});
      });
    }
